...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("PHASE 4: POST-MIGRATION COMPLIANCE AUDIT")
    print("="*80)
    for r in all_reports:
        verdict_tag = "[PASS]" if r['compliance_status'] == "PASSED_100_PERCENT_PARITY" else "[WARN]"
        print(f"{verdict_tag} {r['target_github_repository']}")
