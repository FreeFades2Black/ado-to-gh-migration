...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("PHASE 1: REPOSITORY TRIAGE AND STALENESS AUDIT MANIFEST")
    print("="*80)
    for r in results:
        marker = "[OK]" if r['classification'] == "ACTIVE" else ("[WARN]" if r['classification'] == "EPHEMERAL" else "[ARCHIVE]")
        print(f"{marker} [{r['classification']}] {r['repository']}")
